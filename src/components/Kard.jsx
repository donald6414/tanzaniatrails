...
export default function Kard({ item }) {
  console.log(item);
  return (
    <div>
        ...
        >
          <div class="relative pb-48 overflow-hidden">
            <img
              ...
              src={"https://api.tanzaniatrails.co.tz/" + item.image_url}
              alt=""
            />
          </div>
          <div class="p-4">
          ...
          <div class="p-4 border-t border-b text-xs text-gray-700">
            ...
            <span class="flex items-center">
              ...
              Tour start : <b>{item.package_getting_there.tour_start.title} </b>
              , Tour End :<b> {item.package_getting_there.tour_end.title}</b>
            </span>
          </div>
